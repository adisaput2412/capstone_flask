...
def index():
    ...
    fam = top_category.reset_index().loc[0,'Category']
    ...
    area = playstore['Installs'].values/10000000 # ukuran besar/kecilnya lingkaran scatter plot lingkaran scatter plot
    ...
    df_type = playstore.groupby(['Type'])[['App']].count()
    fig = plt.figure(figsize=(6,6))
    plt.pie(df_type['App'], labels=df_type.index, autopct='%.1f%%')
